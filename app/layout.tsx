      ...
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: 'try{if(window.sessionStorage.getItem("opening-loader-played-v1")&&!new URLSearchParams(window.location.search).has("loader"))document.documentElement.dataset.openingLoaderSeen="1";var t=window.localStorage.getItem("curation-theme");if(t!=="light"&&t!=="dark")t=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";document.documentElement.dataset.curationTheme=t}catch{}',
          }}
        />
      </head>
      <body>
